...
st.write("## Prediction Result: {algorithm}")
st.write("## Prediction min_support: {min_support}")
st.write("## Prediction min_confidence: {min_confidence}")
st.write("## Prediction min_lift: {min_lift}")
